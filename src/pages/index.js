  ...
  render() {
    const heroImg =
      this.state.width < 415
        ? this.props.data.imageHeroMobile.childImageSharp.fluid
        : this.props.data.imageHero.childImageSharp.fluid
    return (
      <Layout>
        <section>
          ...
          <div className={styles.heroInner}>
            ...
            <p>
              Natūralus probiotikas skirtas sustiprinti naminių gyvūnų sveikatą
              ir imunitetą.
            </p>
            <ReadMoreBtn />
          </div>
        ...
        <div className={styles.mainPitch}>
          ...
          <div className={styles.animalGroupSection}>
            <AnimalCard
              title="Katės"
              img={this.props.data.imageCat.childImageSharp.fluid}
            />
            <AnimalCard
              title="Šunys"
              img={this.props.data.imageDog.childImageSharp.fluid}
            />
            <AnimalCard
              title="Triušiai"
              img={this.props.data.imageRabbit.childImageSharp.fluid}
            />
            <AnimalCard
              title="Papūgos"
              img={this.props.data.imageParrot.childImageSharp.fluid}
            />
          </div>
          <ReadMoreBtn />
        </div>
